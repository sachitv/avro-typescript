...
describe('DoubleType', () => {
  ...
  describe('read', () => {
    ...
    it('should throw when insufficient data', () => {
      ...
      assertThrows(() => {
        type.read(tap);
      }, Error, 'Insufficient data for double');
    });
  });
  ...
  describe('createResolver', () => {
    ...
    it('should throw error for unsupported type', () => {
      ...
      }, Error, 'Schema evolution not supported from writer type: double to reader type: double');
    });
  });
  ...
  describe('inheritance from PrimitiveType and BaseType', () => {
    ...
    it('should clone IEEE-754 special values', () => {
      ...
      assertEquals(type.clone(Number.POSITIVE_INFINITY), Number.POSITIVE_INFINITY);
      assertEquals(type.clone(Number.NEGATIVE_INFINITY), Number.NEGATIVE_INFINITY);
    });
