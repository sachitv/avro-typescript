...
describe('BytesType', () => {
  ...
  describe('read', () => {
    ...
    it('should throw when insufficient data', () => {
      ...
      assertThrows(() => {
        type.read(tap);
      }, Error, 'Insufficient data for bytes');
    });
  });
  ...
  describe('createResolver', () => {
    ...
    it('should throw when reading string with insufficient data in resolver', () => {
      ...
      assertThrows(() => resolver.read(readTap), Error, 'Insufficient data for string');
    });
    ...
    it('should throw error for unsupported type', () => {
      ...
      }, Error, 'Schema evolution not supported from writer type: bytes to reader type: bytes');
    });
  });
